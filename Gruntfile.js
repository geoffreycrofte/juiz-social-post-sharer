    ...
    makepot: {
      target: {
        options: {
          ...
          exclude: ['build/.*'],
          mainFile: 'juiz-social-post-sharer.php',    // Main project file.
          potFilename: 'jsps_lang.pot',    // Name of the POT file.
          potHeaders: {
          ...
          processPot: function( pot, options ) {
            pot.headers['report-msgid-bugs-to'] = 'http://geoffrey.crofte.fr/';
