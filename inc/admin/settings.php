		...
		<div class="juiz_bottom_links">
			<div class="juiz_bottom_links_container">
				...
				<div class="juiz_btns_set">
					...
					<a class="juiz_btn_link juiz_flattr" target="_blank" href="https://flattr.com/@CreativeJuiz" lang="en" hreflang="en" aria-label="<?php printf( __( 'Donate with %s', 'juiz-social-post-sharer' ), 'Flattr' ); ?>">
					...
					<a class="juiz_btn_link juiz_flattr juiz_full_width" target="_blank" href="https://www.buymeacoffee.com/geoffreycrofte" lang="en" hreflang="en" aria-label="<?php printf( __( 'Donate with %s', 'juiz-social-post-sharer' ), 'Buy Me a Coffee' ); ?>">
