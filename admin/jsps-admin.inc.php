...
function juiz_sps_activation() {
	...
	if ( ! is_array( $juiz_sps_options ) ) {
		...
		$default_settings = jsps_get_initial_settings();
		
		jsps_update_option( $default_settings );
		...
		if ( ! isset( $juiz_sps_options['juiz_sps_force_pinterest_snif'] ) ) {
			...
			jsps_init_option_ms( $updated_array );
		}
...
/**
 * Return the initial settings for the plugin to work.
 */
...
function juiz_sps_settings_page() {
	...
	<div id="juiz-sps" class="wrap">
		...
		<p class="juiz_bottom_links">
			...
			<a href="https://flattr.com/@geoffreycrofte" lang="en" hreflang="en"><img src="https://api.flattr.com/button/flattr-badge-large.png" alt="Flattr this!" width="93" height="20" style="vertical-align:-6px;"></a>
